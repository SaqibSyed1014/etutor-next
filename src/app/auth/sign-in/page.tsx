...
const SignIn = () => {
    ...
    return (
        <div className="flex flex-1 overflow-hidden">
            ...
            <div className="w-full max-w-[45%] hidden md:flex bg-secondary-100 items-end justify-center">
                <img
                    src="/images/illustrations/saly.png"
            ...
            <div className="overflow-auto flex-1 h-full">
                    <div className="min-h-full flex items-center justify-center py-20 px-6">
                        <div className="w-full max-w-[535px] xl:max-w-[648px] section-layout">
