...
>(({ className, children, ...props }, ref) => (
    <SelectPrimitive.Trigger
        ref={ref}
        className={cn(
            "select-option flex h-10 w-full items-center text-gray-500 justify-between border border-gray-100 px-[18px] py-3 text-base disabled:cursor-not-allowed disabled:opacity-50 [&>span]:truncate focus:outline-none data-[state=open]:ring-1 data-[state=open]:ring-primary-500",
            className
        )}
        {...props}
    >
...
>(({ className, children, position = "popper", ...props }, ref) => (
    <SelectPrimitive.Portal>
        <SelectPrimitive.Content
            ref={ref}
            className={cn(
                "relative z-50 bg-white max-h-96 min-w-[8rem] overflow-hidden border text-popover-foreground shadow-md data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2",
                position === "popper" &&
